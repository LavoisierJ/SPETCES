...
data_noise = np.load(f'{master_path}/datasets/dataset_preliminary_work/prelim_signal_noise/raw_dataset/noise_dataset_1000_traces_noise15_SNR4.npy')
data_signal = np.load(f'{master_path}/datasets/dataset_preliminary_work/prelim_signal_noise/raw_dataset/simu_dataset_1000_traces_noise15_SNR4.npy')
...
number_data = np.shape(data_noise)[0]
...
# Save datasets
np.save(f'{master_path}/datasets/dataset_preliminary_work/prelim_signal_noise/train_test_datasets/noise_dataset_train_800_traces_noise15_SNR4.npy', train_set_noise)
np.save(f'{master_path}/datasets/dataset_preliminary_work/prelim_signal_noise/train_test_datasets/noise_dataset_test_200_traces_noise15_SNR4.npy', test_set_noise)
np.save(f'{master_path}/datasets/dataset_preliminary_work/prelim_signal_noise/train_test_datasets/simu_dataset_train_800_traces_noise15_SNR4.npy', train_set_signal)
np.save(f'{master_path}/datasets/dataset_preliminary_work/prelim_signal_noise/train_test_datasets/simu_dataset_test_200_traces_noise15_SNR4.npy', test_set_signal)
